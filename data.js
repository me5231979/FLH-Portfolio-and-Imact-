...
window.FLH = {
  ...
  goals: [
    { num: 1,
      ...
      measure: 'Engagement Consultants work all 39 business units to identify critical roles; talent is assessed against validated skills from the skills-based job architecture; Oracle is the system of record and the Talent Portal platform carries all-staff communication.',
      kpis: [
        ...
        { label: 'All staff informed of and enrolled into the Talent Portal platform, engagement monitored', target: '100% of staff', pct: null }
      ],
      scale: [
